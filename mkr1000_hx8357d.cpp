...
//    writeData(0x00);  //disable SDO pin!
	...
	Serial.print("Display Power Mode: 0x"); Serial.println(ret, HEX);

	ret = readData(HX8357_RDMADCTL);
	Serial.print("MADCTL Mode: 0x"); Serial.println(ret, HEX);

	ret = readData(HX8357_RDCOLMOD);
	Serial.print("Pixel Format: 0x"); Serial.println(ret, HEX);

	ret = readData(HX8357_RDDIM);
	Serial.print("Image Format: 0x"); Serial.println(ret, HEX);

	ret = readData(HX8357_RDDSDR);
	Serial.print("Self Diagnostic: 0x"); Serial.println(ret, HEX);
